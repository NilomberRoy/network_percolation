...
for(int i=0; i<degree_distribution.size(); i++){
    cout<<fixed<< setprecision(10)<<(i)<<"  "<<setprecision(10)<<(double)log(i)<<"  "<<setprecision(10)<<(double)(degree_distribution[i])/(N0*en_count)<<"  "<<setprecision(10)<<(double)log((double)(degree_distribution[i])/(N0*en_count))<<endl;
    file<<fixed<< setprecision(10)<<(i)<<"  "<<setprecision(10)<<(double)log(i)<<"  "<<setprecision(10)<<(double)(degree_distribution[i])/(N0*en_count)<<"  "<<setprecision(10)<<(double)log((double)(degree_distribution[i])/(N0*en_count))<<endl;
...
int main(int argc, char* argv[]){
    ...
    deg_dist="mda_deg_N0"+to_string(N0)+"_m0"+to_string(m0)+"_en"+to_string(en_count)+"_prob"+to_string(p)+"_fnum"+to_string(filenum)+".dat";
	degree_dist();
